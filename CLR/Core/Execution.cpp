...
#if !defined(BUILD_RTM)
#if defined(TINYCLR_TRACE_MEMORY_STATS) && (defined(PLATFORM_ARM_Netduino) || defined(PLATFORM_ARM_NetduinoPlus) || defined(PLATFORM_ARM_NetduinoMini) || defined(PLATFORM_ARM_NetduinoGo) || defined(PLATFORM_ARM_NetduinoShieldBase))
