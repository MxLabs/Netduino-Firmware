...
#if defined(HAL_REDUCESIZE) && !defined(PLATFORM_ARM_Netduino) && !defined(PLATFORM_ARM_NetduinoPlus) && !defined(PLATFORM_ARM_NetduinoMini) || defined(PLATFORM_ARM_NetduinoGo) || defined(PLATFORM_ARM_NetduinoShieldBase)
    // No config update.
    return FALSE;
#else
